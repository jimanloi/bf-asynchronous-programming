...
const intervalId = setInterval(exercise5_cb_0, 200);
...
setTimeout(exercise5_cb_2, 1500);
...
setTimeout(exercise5_cb_3, 1300);
...
setTimeout(exercise5_cb_5, 1100);
